        ...
        <>
            ...
            <div className={`settings-panel ${isOpen ? 'open' : ''}`}>
                ...
                <div className="settings-content">
                    {/* Appearance Dropdown */}
                    <div className="settings-item dropdown" onClick={() => setIsAppearanceOpen(!isAppearanceOpen)}>
                        ...
                        <svg
                            className={`dropdown-arrow ${isAppearanceOpen ? 'open' : ''}`}
                    ...
                    {isAppearanceOpen && (
                        <div className="settings-submenu">
                            <div
                                className={`settings-subitem ${theme === 'light' ? 'active' : ''}`}
                            ...
                            <div
                                className={`settings-subitem ${theme === 'dark' ? 'active' : ''}`}
